...
\begin{exercicio}
  ...
  Se $T$ é uma árvore de altura $\omega$, com todos os níveis finitos, então T admite um ramo de comprimento $\omega$.
  \end{teo}
  \begin{proof}
  ...
  Falta verificar que $\{a\in T: c_n\geq a \text{ para algum } n\}$ é um ramo de $T$ com comprimento $\omega$.
